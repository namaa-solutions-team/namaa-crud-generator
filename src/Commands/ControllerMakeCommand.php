...
class ControllerMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'make-controller-crud-with-translations';
    ...
    protected function getTemplateContents()
    {
        ...
        return (new Stub($this->getStubName(), [
            ...
            'MODEL' => str_replace('Controller', '', $this->getControllerNameWithoutNamespace()),
            'MODEL_SNAKE' => Str::of(str_replace('Controller', '', $this->getControllerNameWithoutNamespace()))->snake(),
            'MODEL_PLURAL' => Str::plural(Str::of(str_replace('Controller', '', $this->getControllerNameWithoutNamespace()))->snake()),
